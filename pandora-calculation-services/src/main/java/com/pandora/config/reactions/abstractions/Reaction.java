...
/**
 * The {@code Reaction} class represents an abstract implementation of the {@link ReactionConfiguration} interface,
 * providing common functionality for configuring biogeochemical reactions in freshwater systems.
 * <p>
 * This class includes fields for accessing the Spring framework's environment and a service for managing
 * {@link com.pandora.config.species.abstractions.Specie} beans. It also
 * initializes maps to store species produced and removed by the reaction, along with their corresponding quantities.
 * Developers can extend this class to implement specific reaction configurations.
 *
 * @version 0.0.1
...
public abstract class Reaction implements ReactionConfiguration {
     ...
     * and retrieving instances of {@link com.pandora.config.species
     ...
     * @see Reaction
     * @see com.pandora.config.species .abstractions.Specie
     */
    @Autowired
