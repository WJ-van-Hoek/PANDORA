 ...
 * <ul>
 * <li>{@link com.pandora.general.Particle}: An interface defining methods for
 * obtaining properties of individual particles, such as radius and density.</li>
 * <li>{@link com.pandora.general.ParticulateSpecieBean}: An abstract class
 * implementing the {@link com.pandora.general.Particle} interface, providing
 * properties and methods related to particle deposition rate based on Stokes' law.</li>
 * <li>{@link com.pandora.general.Sediment}: An interface defining methods for
 * obtaining properties of sediment particles, including radius, density, and characteristics relevant to sediment
 * transport.</li>
 * <li>{@link com.pandora.general.SedimentSpecieBean}: An abstract class
 * implementing the {@link com.pandora.general.Sediment} interface, providing
