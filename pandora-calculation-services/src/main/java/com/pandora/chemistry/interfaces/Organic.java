...
/**
 * The {@code Organic} interface represents an organic chemical entity in PANDORA chemistry, and it defines a method to
 * retrieve the oxidation rate associated with this organic species.
 * <p>
