...
import com.science.earth.biogeochemistry.freshwaters.PANDORA.services.crudservices.interfaces.AbstractBaseEntityService;
...
public abstract class AbstractBaseEntityServiceImpl<T extends AbstractBaseEntity, R extends AbstractBaseEntityRepository<T>>
    ...
    protected AbstractBaseEntityServiceImpl(R repository, ErrorMessageGenerator errorMessageGenerator) {
