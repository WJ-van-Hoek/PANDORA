...
public class CellTimestepServiceImplIntergrationMonthsTest {
    ...
    void testCalculateTimeSeriesMonths() {
        ...
        this.cellTimestepService.calculateTimeSeries(CELL, T_0, 1);
        Assertions.assertNotNull ( yMapService.findAtCellAndTimestep(CELL, T_0.plusMonths(1)));
