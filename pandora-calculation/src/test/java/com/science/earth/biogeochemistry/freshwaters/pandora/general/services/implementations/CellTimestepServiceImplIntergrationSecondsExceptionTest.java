...
@SpringBootTest
@TestPropertySource (locations = "classpath:test1.properties", properties = {"pandora.timestep.unit=second","timestep.unit=second"})
public class CellTimestepServiceImplIntergrationSecondsExceptionTest {
    ...
    @Test
    void testCalculateTimeSeriesSecondsException() {
