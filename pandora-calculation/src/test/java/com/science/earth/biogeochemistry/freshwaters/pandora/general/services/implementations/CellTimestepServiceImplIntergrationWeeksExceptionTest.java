...
@SpringBootTest
@TestPropertySource (locations = "classpath:test1.properties", properties = {"pandora.timestep.unit=week","timestep.unit=week"})
public class CellTimestepServiceImplIntergrationWeeksExceptionTest {
    ...
    @Test
    void testCalculateTimeSeriesWeeksException() {
