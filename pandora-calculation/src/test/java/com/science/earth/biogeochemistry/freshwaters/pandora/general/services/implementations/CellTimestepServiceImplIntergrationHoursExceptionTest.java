...
//
//@SpringBootTest
//@TestPropertySource (locations = "classpath:test1.properties", properties = {"pandora.timestep.unit=hour","timestep.unit=hour"})
//public class CellTimestepServiceImplIntergrationHoursExceptionTest {
...
//
//    @Test
//    void testCalculateTimeSeriesHoursException() {
