...
//
//@SpringBootTest
//@TestPropertySource (locations = "classpath:test1.properties", properties = {"pandora.timestep.unit=minute","timestep.unit=minute"})
//public class CellTimestepServiceImplIntergrationMinutesExceptionTest {
...
//
//    @Test
//    void testCalculateTimeSeriesMinutesException() {
