...
/**
 * The {@code SpeciesController} class handles HTTP requests related to species information. It provides endpoints for
 * retrieving information about available species.
 *
