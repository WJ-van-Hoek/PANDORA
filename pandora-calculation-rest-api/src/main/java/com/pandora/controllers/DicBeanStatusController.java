...
import com.pandora.config.species.services.DicBeanStatusService;

/**
 * The {@code DicBeanStatusController} class serves as a Spring MVC controller handling HTTP requests related to the
 * status of the DIC bean. It is annotated with {@link RestController} and is conditionally enabled based on the
 * "dic.enabled" property.
 *
