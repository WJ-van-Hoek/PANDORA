 ...
 * PANDORA controllers. These response bodies encapsulate data or results generated during calculations or processing,
 * providing a structured format for communication with clients.
 * <p>
 * The main classes/interfaces in this package include:
 * <ul>
 * <li>{@link com.pandora.controllers.responsebodies.CellCalculationResponse CellCalculationResponse}:
 * <p>
 * Represents a response object containing a list of {@link com.pandora.general.objects.CellTimestep CellTimestep}
 * objects.</li>
 * <li>{@link com.pandora.controllers.responsebodies.SpeciesResponse SpeciesResponse}:
 * <p>
